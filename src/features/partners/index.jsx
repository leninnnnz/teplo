                ...
                <div className={style.partnerInfo}>
                    <div>
                        ...
                        <section className={style.section}>
                            <p className={style.text}>Адрес в сети:</p>
                            <a href="http://www.kanova.ru/" className={style.siteLink} target="_blank" rel="noopener noreferrer">
                                www.kanova.ru
                            </a>
                        </section>
                        ...
                        <section className={style.section}>
                            <p className={style.text}>Телефон:</p>
